...
namespace input {
    ...
    public:
        Instance() = default;
        ///@param input A variable-length vector of type T used to construct the Instance class instance
        ...
        ///@param index A 64-bit integer indicating the index of a factor of the data point vector
        ...
        ///@return A double representing the distance between this Instance and the other Instance
        ///@brief Returns the euclidean distance (2-norm of the difference) between this Instance and the passed Instance.
        ///Both must be of arithmetic type
    ...
    public:
        ...
        ///@param input A variable-length vector of type T used to construct the LabeledInstance class instance
        ...
        ///@brief Construct the LabeledInstance from the elements of the array and tags it with label
